...
fig_compare.update_layout(
    height=600, title_text="Сравнение стратегий — Si (equity, 1 контракт)",
    title_x=0.5,
    showlegend=True,
...
fig.update_layout(
    ...
    title_text=f"Комбинированная стратегия — Si<br><sub>{stats_text}</sub>",
    title_x=0.5,
    showlegend=True,
...
fig_stats.update_layout(
    title_text="<b>Комбинация — Si: статистика стратегии</b>",
...
fig_table.update_layout(
    title_text="<b>Комбинация — Si: ключевые коэффициенты</b>",
    title_x=0.5, title_font_size=18,
...
with OUTPUT_HTML.open("w", encoding="utf-8") as f:
    ...
    f.write("<title>Сравнение стратегий — Si</title>\n")
    f.write("<style>\n")
    ...
    f.write("</style>\n</head><body>\n")
    f.write("<h2 style='text-align:center;'>Сводная статистика — Si</h2>\n")
    f.write(stats_html)
